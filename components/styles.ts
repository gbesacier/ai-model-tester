...
export const styles = {
  ...
  card: {
    ...
    actionPrimary: 'inline-flex items-center gap-1 rounded px-2 py-1 text-xs font-medium text-white bg-blue-600 hover:bg-blue-700',
  },

  // Listbox multi-select dropdowns
  listbox: {
    button: 'text-left flex items-center justify-between',
    options: 'w-(--button-width) z-50 mt-1 bg-white border border-gray-300 rounded shadow-lg max-h-48 overflow-y-auto',
    controlsHeader: 'p-2 border-b border-gray-200 flex gap-2 sticky top-0 bg-white',
    selectAll: 'text-xs px-2 py-1 bg-blue-100 text-blue-700 rounded hover:bg-blue-200',
    selectNone: 'text-xs px-2 py-1 bg-gray-100 text-gray-700 rounded hover:bg-gray-200',
    option: 'group flex items-center gap-2 px-4 py-2 hover:bg-gray-50 cursor-pointer',
    optionCheckbox: 'w-4 h-4 border border-gray-300 rounded flex items-center justify-center group-data-selected:bg-blue-600 group-data-selected:border-blue-600 shrink-0',
    optionCheckmark: 'hidden group-data-selected:block text-white text-xs leading-none',
  },
